...
import profile from '../../assets/kapil_user.jpg'
import lighting from '../../assets/kapil.gif.jpg'
const About = () => {
  return (
      ...
      <div className="about-section">
        ...
        <div className="about-right">
          <div className="about-para">
            <p>Hello, I’m Kapil Goswami, a passionate full stack developer with a strong focus on the MERN stack (MongoDB, Express.js, React.js, and Node.js). I recently completed my Bachelor’s in Computer Applications from the Hierank Business School Noida sec 62, where I built a solid foundation in computer science and software development.</p>
